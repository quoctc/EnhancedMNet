...
class MobileNetV1(torch.nn.Module):
    ...
    def __init__(self,
        ...
        self.filter_instance = Filter(num_gabor_filters=num_gabor_filters)
...
def build_mobilenet_v1(num_classes, width_multiplier=1.0, cifar=False, use_filter='Gabor', num_gabor_filters = 8):
    """
...
def build_mobilenet_v2(num_classes, width_multiplier=1.0, 
                       cifar=False, 
                       use_filter='Gabor', num_gabor_filters = 8):
    """
