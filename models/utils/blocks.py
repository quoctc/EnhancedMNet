...
class BaseBlock(nn.Module):
    ...
    def __init__(self, input_channel, output_channel, t = 6, downsample = False, BN_momentum = 0.1):
        """
        ...
        self.bn1 = nn.BatchNorm2d(c, momentum=BN_momentum)
        # 3x3   depth wise conv
        self.conv2 = nn.Conv2d(c, c, kernel_size = 3, stride = self.stride, padding = 1, groups = c, bias = False)
        self.bn2 = nn.BatchNorm2d(c, momentum=BN_momentum)
        # 1x1   point wise conv
